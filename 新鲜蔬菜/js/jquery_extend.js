        ...
        "SimpleTableHandle": function (options){
            options = $.extend({
                ...
                addrowfun:function(element,options){
                    ...
                    options.addprefun(that,globalOptions,options.rowdatas,options.rowtmplstr);

                    options.appendrows(element,options,options.rowdatas,options.rowtmplstr);

                    options.addafterfun(that,globalOptions,options.rowdatas,options.rowtmplstr);
                ...
                appendrows:function(element,options,rowdatas,rowtmplstr){
                    ...
                    if(_checkParamValid9(rowtmplstr)>9&&$.trim(rowtmplstr)!=""&&_checkParamValid9(rowdatas)>9){
                        ...
                        if(element.children("tbody:first").length>0){
                            element.children("tbody:first").append(options.builderhtmlstr(element,options,rowdatas,rowtmplstr));
                        }else{
                            element.append(options.builderhtmlstr(element,options,rowdatas,rowtmplstr));
                        }
                    }
                },
            ...
            that.appendrows = function(rowdatas,rowtmplstr,prefun,afterfun){
                ...
                globalOptions.appendrows(that,globalOptions,rowdatas,otmpls);
